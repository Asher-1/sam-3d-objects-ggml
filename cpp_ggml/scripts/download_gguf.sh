...
#   bash cpp_ggml/scripts/download_gguf.sh --model ss_decoder    # every dtype of one model
...
MANIFEST=(
    "ss_generator|3200717792|6394703840|1704687392|906804480|1006539840|917838720"
